/*
  Startup compatibility fixes for the v0.3 enhancement layer.
  Kept separate so the main enhancement file remains easy to review.
*/

window.addEventListener("DOMContentLoaded", applyV03StartupFixes);

function applyV03StartupFixes() {
