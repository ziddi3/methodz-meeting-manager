...
test("recovery readiness panel and guarded import architecture load", async ({ page }) => {
...
test("current workspace recovery drill records a passing metadata-only event", async ({ page }) => {
  await page.evaluate(() => {
