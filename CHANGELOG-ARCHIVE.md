...
This file preserves release history moved out of the current `CHANGELOG.md` during the v1.6.6 documentation consolidation.

## Additional 1.6.0 security notes
